...
//   mjDSBL_FRICTIONLOSS = 1<<2,     // joint and tendon frictionloss
//   constraints mjDSBL_LIMIT        = 1<<3,     // joint and tendon limit
//   constraints mjDSBL_CONTACT      = 1<<4,     // contact constraints
...
//   mjDSBL_REFSAFE      = 1<<11,    // integrator safety: make
//   ref[0]>=2*timestep mjDSBL_SENSOR       = 1<<12,    // sensors
//   mjDSBL_MIDPHASE     = 1<<13,    // mid-phase collision filtering
//   mjDSBL_EULERDAMP    = 1<<14,    // implicit integration of joint damping in
//   Euler integrator
